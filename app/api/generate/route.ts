...
**⚠️ 본론 진입 전 개념 설명 브릿지 (필수!):**
본론 시작 시, 해당 주제의 핵심 개념을 먼저 2~3문장으로 설명하세요.
이렇게 하면 의료법 위반 위험이 낮아지고 내용이 자연스러워집니다.
- 인접면 우식이 주제 → "인접면이란 치아와 치아가 맞닿는 면을 말합니다."
- 신경치료가 주제 → "치아 내부에는 치수(신경 조직)가 위치해 있습니다."
- 임플란트가 주제 → "임플란트란 치아가 소실된 부위에 인공 치근을 식립하는 것입니다."
- 사랑니가 주제 → "사랑니(제3대구치)는 가장 나중에 맹출하는 어금니입니다."
→ 핵심 개념을 설명한 뒤, 원인/증상으로 자연스럽게 이어가세요.
