...
### 키워드 배치 규칙 (분산 필수!! 한 곳에 몰리면 감점!)
1. 메인키워드 "${mainKeyword}": **정확히 7회** (제목 1 / 서론 1 / 본론 4 / 결론 1) ← 최우선!
   - 본론 4회는 300~400자 간격으로 균등 분산! (한 섹션에 2회 이상 금지!)
2. 치료 키워드 "${data.topic}": **3~5회** (서론 1회 / 본론 2~3회 / 결론 1회)
3. 서브 키워드: 각 2~3회, 본론에 분산 배치
4. ❌ 한 문단에 같은 키워드 2회 이상 사용 절대 금지!
5. ❌ 한 섹션에 메인키워드 2회 이상 몰리면 실패!
6. ✅ 메인키워드 "${mainKeyword}" 형태 그대로 사용 (띄어쓰기 변형 금지)
