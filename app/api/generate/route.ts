...
**올바른 예:**
- 📷 [이미지 위치: 치료 전 X-ray 사진 - 수평으로 매복된 사랑니가 인접 치아를 압박하는 모습]
- 📷 [이미지 위치: 치료 후 상태 - 발치 부위가 깨끗하게 치유된 모습]
- 📷 [이미지 위치: 치료 과정 일러스트 - 사랑니 분할 발치 단계별 설명 다이어그램]
- 📷 [이미지 위치: CT 촬영 이미지 - 사랑니와 하치조신경의 위치 관계]
...
**예시:**
"임플란트 시술 성공률은 약 95~98% 수준으로 보고되고 있어요. (출처: [대한치과의사협회](https://www.kda.or.kr))"
