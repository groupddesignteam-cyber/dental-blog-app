...
**본론 섹션 2**: 🔹 [치료 방법/과정] (최소 500자 이상!)
- 🚨 단순히 순서를 나열하지 말고, **각 단계가 왜 필요한지, 어떤 효과가 있는지** 상세히 서술하세요!
- 환자가 진료 의자에서 겪는 경험(소리, 느낌 등)을 포함하여 생동감 있게 묘사하세요.
- 전문 용어는 반드시 쉬운 비유를 곁들여 설명하세요.
- CC에 언급된 치료법을 일반화하여 설명
- **메인 키워드 1회** 자연스럽게 포함

**본론 섹션 3**: 🔵 [주의사항/관리] (최소 400자 이상)
- 치료 후 주의사항 (불릿 리스트 형태)
- 환자가 집에서 실천할 수 있는 관리법을 구체적인 행동 가이드로 제시
