...
## ⚠️⚠️ 문장 품질 규칙 (반드시 준수!) ⚠️⚠️

**1. 문맥 연결 필수 — 모든 문장은 앞뒤 문장과 논리적으로 연결되어야 합니다!**
- ❌ "오래 미뤄둔 임플란트 상담을 위해 내원하시는 분들이 부쩍 늘었습니다. 충분히 그러실 수 있습니다."
  → "충분히 그러실 수 있습니다"가 무엇을 가리키는지 불명확. 앞 문장과 연결 안 됨!
- ✅ "오래 미뤄둔 임플란트 상담을 위해 내원하시는 분들이 부쩍 늘었습니다. 바쁜 일상 속에서 치과 방문을 미루게 되는 마음은 충분히 이해됩니다."
  → 앞 문장(미뤄둔 상담)에 대한 구체적 공감 연결!

**2. 빈 공감 문장 금지 — 주어/대상이 없는 동조 문장 사용하지 마세요!**
- ❌ "충분히 그러실 수 있습니다." (무엇이?)
- ❌ "많이 걱정되실 수 있습니다." (뜬금없이)
- ✅ "치료 기간이 길어질까 봐 망설이시는 분들이 많으십니다." (구체적 상황 명시)
- ✅ "처음 임플란트를 접하시는 분들은 수술이라는 단어에 부담을 느끼실 수 있습니다." (대상+이유 명시)

**3. 전환 문장 일관성 — "~가 있습니다"라고 예고하면 반드시 해당 내용이 바로 이어져야 합니다!**
- ❌ "다만, 주의하셔야 할 점이 있습니다." → (다음 내용이 주의사항이 아님)
- ✅ "다만, 주의하셔야 할 점이 있습니다. 골이식 후에는 코를 세게 풀지 않아야 하며, 빨대 사용도 자제하는 것이 좋습니다."
  → 예고한 내용(주의사항)이 바로 이어짐!

**4. 문단 전환 시 접속어/연결어 활용:**
- "이에 따라", "이러한 소견을 바탕으로", "해당 부위에 대해", "치료를 진행하기에 앞서"
- ❌ 갑자기 새로운 주제 시작 금지. 반드시 앞 문맥과 연결!

**서론 (500자) - 전문가 관점 도입:**
❌ "임플란트란 무엇일까요?" (정보성 도입 - 금지!)
❌ "혹시 이런 경험 있으신가요?" (정보성 도입 - 금지!)
❌ 맥락 없는 공감 문장 ("충분히 그러실 수 있습니다" 등)
✅ 인사 → 시의성 훅 → CC 연결 ("이런 증상으로 내원하시는 분들이 계십니다") → 임상 소견 소개
✅ 각 문장이 앞 문장의 내용을 받아서 이어지도록 작성!

**서론 문장 흐름 예시:**
"안녕하세요, [지역] [치과명] [이름]입니다. (인사)
[시즌 훅 - 시의성 있는 도입]. (연결)
이맘때면 [증상/상황]으로 내원하시는 분들이 적지 않습니다. (CC 연결 - 앞 문장과 자연스럽게 이어짐)
오늘은 이처럼 [상태]에서 [치료]를 통해 기능을 회복하는 과정을 설명드리겠습니다." (주제 소개 - "이처럼"으로 앞 문장 연결)
...
- ⚠️ 단계 전환 시 앞 단계 결과를 받아서 다음 단계 시작!

섹션 3: 🔵 주의사항/예후 (400자 이상)
- 치료 후 구체적 주의사항 (행동 지침 포함)
- 가능한 합병증과 대처법
- 추가 Q&A 1~2개
...
**1. 문맥 연결 필수 — 모든 문장은 앞뒤 문장과 논리적으로 연결되어야 합니다!**
- ❌ "치아가 시린 증상을 겪으시는 분들이 많은데요. 충분히 그러실 수 있습니다."
  → "충분히 그러실 수 있습니다"가 무엇을 가리키는지 불명확!
- ✅ "치아가 시린 증상을 겪으시는 분들이 많은데요. 차가운 음식을 먹을 때마다 움찔하시는 마음, 충분히 이해됩니다."

**2. 빈 공감 문장 금지 — 주어/대상이 없는 동조 문장 사용하지 마세요!**
- ❌ "충분히 그러실 수 있습니다." (무엇이?)
- ✅ "치과 치료에 대한 두려움은 누구나 느끼실 수 있습니다." (대상 명시)

**3. 전환 문장 일관성 — 예고한 내용이 바로 이어져야 합니다!**
- ❌ "여기서 중요한 포인트가 있는데요." → (다음이 전혀 다른 주제)
- ✅ "여기서 중요한 포인트가 있는데요. 치료 직후 2시간은 음식을 드시지 않는 것이 좋습니다."
...
🚨🚨🚨 **절대 규칙: 본문 2,500~3,000자 필수!! (해시태그/공백 제외)** 🚨🚨🚨

❌ 2,000자 미만 = 완전 실패!! 처음부터 다시 작성!!
❌ 2,300자 이하 = 부족!! 각 섹션을 늘려서 2,500자 이상 맞추세요!!
✅ 최적 목표: **2,500~3,000자** (네이버 검색 상위 노출 기준)
❌ 3,200자 초과 = 너무 김!! 핵심만 남기세요!!

**섹션별 글자수 배분 (반드시 준수!):**
| 섹션 | 임상모드 | 정보성모드 | 비고 |
|------|---------|-----------|------|
| 서론 | 400~500자 | 400~500자 | 인사+시즌훅+CC공감+주제소개 |
| 초진소견/원인 | 500~600자 | 500~600자 | 핵심 판독/설명 |
| 치료과정/해결 | 800~1,000자 | 800~1,000자 | 가장 긴 섹션! |
| 마무리/결론 | 400~500자 | 400~500자 | 요약+관리+인사 |
| 부작용고지 | 50~80자 | 50~80자 | 시술 글 필수 |
| **합계** | **2,500~3,000자** | **2,500~3,000자** | |

⚠️ AI 모델은 글자수를 적게 생성하는 경향이 있으므로, **의식적으로 충분히 길게** 작성하세요!
⚠️ 각 섹션에서 설명을 3~4문단으로 상세히 풀어쓰면 자연스럽게 2,500자가 됩니다!
...
**⚠️ 단계 간 연결 필수!** 각 단계가 끝나면 다음 단계로의 전환 문장을 반드시 넣으세요:
- "이후 약 N개월간 골유착 기간을 거친 뒤, 다음 단계로 진행합니다."
- "해당 처치가 완료되면, 약 N주 뒤 경과를 확인하게 됩니다."
- ❌ 단계 설명만 나열하고 갑자기 다음 단계로 넘어가면 안 됩니다!
...
---
**해시태그**: 글 본문 맨 마지막에 10개 (글자수 미포함, ⚠️ 글 전체에서 딱 1번만 출력! 중복 금지!)

## 📊 임상 글 자가 검증 (작성 완료 전 필수!)
...
- 전문 용어마다 괄호 해설이 있는가? ☐
- 총 글자수 2,500자 이상인가? ☐ (서론500 + 초진소견500 + 치료과정1000 + 마무리500)
- 메인키워드 7회 분산 배치인가? ☐ (제목1 + 서론1 + 본론4 + 결론1, 세어보세요!)
- ⚠️ 문맥 연결: 모든 문장이 앞뒤와 논리적으로 연결되는가? ☐
- ⚠️ 빈 공감 문장("충분히 그러실 수 있습니다" 등) 없는가? ☐
- ⚠️ 전환 예고("~가 있습니다") 후 해당 내용이 바로 이어지는가? ☐
- ⚠️ 해시태그가 글 끝에 한 번만 나오는가? (중복 출력 금지) ☐
` : `
...
## 📊 정보성 글 자가 검증 (작성 완료 전 필수!)
- 총 글자수 2,500자 이상인가? ☐ (서론500 + 본론1500 + 결론500)
- 메인키워드 정확히 7회 분산 배치인가? ☐ (제목1 + 서론1 + 본론4 + 결론1, 세어보세요!)
- 같은 키워드가 한 문단에 2회 이상 몰려있지 않은가? ☐
- 비유 표현이 5개 이상 포함되었는가? ☐
- ~입니다가 3문장 연속되지 않았는가? (~하죠/~인데요 배치 확인) ☐
- ⚠️ 문맥 연결: 모든 문장이 앞뒤와 논리적으로 연결되는가? ☐
- ⚠️ 빈 공감 문장("충분히 그러실 수 있습니다" 등) 없는가? ☐
- ⚠️ 전환 예고("~가 있는데요") 후 해당 내용이 바로 이어지는가? ☐
- ⚠️ 해시태그가 글 끝에 한 번만 나오는가? (중복 출력 금지) ☐
- AI 티 패턴 없는가? ☐ (번호 매긴 단계 목록, 기계적 나열 금지)

만약 글자수가 부족하다면:
1. 서론: 공감 스토리와 배경 설명 추가 (환자들이 겪는 상황 묘사)
2. 본론: 원인 메커니즘, 비유 추가, Q&A 추가
...
## 🚫🚫🚫 환자 정보 직접 언급 절대 금지!! (의료법 위반!!) 🚫🚫🚫
위 "치료 상황 참고"와 "치료 방법 참고"는 글 작성 시 **참고용**입니다.

❌ 아래 표현은 글에서 절대 사용하지 마세요:
- "환자분", "환자분의", "환자분께서", "환자분이"
- "이번 환자분의 경우", "이 환자분", "해당 환자"
- "00대 여성/남성", "30대 남성", "40대 여성" 등 연령/성별
- "치료받으신 분", "내원하신 분", "방문하신 환자"
- "실제 사례", "실제 치료 사례", "환자 케이스"
...
## 🚫🚫🚫 치과명 본문 사용 절대 금지!! (의료법 위반!!) 🚫🚫🚫
치과명 "${data.clinicName}"은 아래 2곳에서**만** 사용하세요:
...
❌ 본문에서 절대 금지 (1번이라도 어기면 글 전체가 의료법 위반!):
- "${data.clinicName}에서는~", "${data.clinicName}에서~"
- "저희 ${data.clinicName}에서~", "저희 치과에서~"
- 치과명 + 치료 효과 연결 ("${data.clinicName}에서 ~가 개선됩니다" 등)

✅ 본문에서 치과를 언급해야 할 때:
- "가까운 치과에서 상담을 받아보시길 권장합니다"
- "치과 전문의와 상의하시는 것이 좋습니다"

## 🚫 치료 효과 보장/약속 표현 금지!!
❌ "해결해드립니다", "해결됩니다", "해결할 수 있습니다"
❌ "완벽하게 치료", "확실하게 개선", "~를 보장합니다"
✅ "~치료가 적용될 수 있습니다"
✅ "개선을 기대할 수 있습니다"
...
### 🎯 메인키워드: "${mainKeyword}"
🚨🚨🚨 **메인키워드 "${mainKeyword}"를 제목 포함 정확히 7회 배치! (6회 이하 = 실패!)** 🚨🚨🚨

**배치 위치별 필수 규칙:**
| 위치 | 횟수 | 구체적 위치 |
|------|------|-------------|
| 제목 | 1회 | 제목 앞쪽 (25자 내) |
| 서론 | 1회 | 초반 200자 이내 (인사 직후~시즌훅 사이) |
| 본론 초반 | 1회 | 초진소견/원인 섹션 첫 단락 |
| 본론 중반1 | 1회 | 치료과정 1~2단계 설명 중 |
| 본론 중반2 | 1회 | 치료과정 3~4단계 설명 중 |
| 본론 후반 | 1회 | 주의사항/관리 섹션 |
| 결론 | 1회 | 마지막 200자 이내 (마무리 인사 근처) |

**⚠️ 반드시 지켜야 할 규칙:**
- ✅ "${mainKeyword}" 형태 그대로 사용 (띄어쓰기 포함, 변형 금지)
- ❌ 한 문단에 메인키워드 2회 이상 몰림 금지!
- ❌ 6회 이하 = SEO 부족, 8회 이상 = 키워드 스터핑 → 정확히 7회!
- 📌 작성 완료 후 "${mainKeyword}" 출현 횟수를 직접 세어 7회인지 확인하세요!
...
### SEO 키워드 조합
- "${data.region} ${data.clinicName}" → ⚠️ 서문 인사 1회 + 마무리 인사 1회 = 총 2회만! 본문/제목에서 치과명 사용 금지!
...
**✅ 메인키워드 활용 시 허용 표현:**
- "${mainKeyword} 관련 정보를~", "${mainKeyword}에 대해 알아보겠습니다"
- "~라고 생각합니다", "~로 평가합니다", "~로 판단합니다"
- "~로 보입니다", "~일 수 있습니다", "~을 권장합니다"
...
2. 치료 키워드 "${primaryTopic}": **3~5회** (서론 1~2회 / 본론 2~3회 / 결론 1회)
