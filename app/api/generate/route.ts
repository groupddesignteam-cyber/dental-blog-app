...
**⚠️ 임상 모드 금지 패턴:**
- ❌ "💡 핵심:", "💡 요약:" 등 이모지 강조 블록 (AI 티 100%!)
- ❌ "충분히 그러실 수 있습니다" 같은 맥락 없는 위로 문장 (앞 문장과 논리적으로 연결되어야 함!)
- ❌ 모든 문장은 앞뒤 맥락과 논리적으로 이어져야 합니다. 갑자기 톤이 바뀌는 공감 문장 삽입 금지!
...
## 📚 정보성 모드 (Informative Mode) — 전문가의 깊이 있는 설명 톤

**목표**: 10년차 치과 전문의가 일반인도 이해할 수 있도록 **전문 지식을 깊이 있게** 전달하는 글
- 대화하는 느낌이 아닌, **지식을 전달하는 전문가** 톤이 핵심!
- 전문 용어 사용 + 일상 비유로 풀어서 설명하되, 내용 깊이가 가장 중요

**⚠️⚠️ 임상 모드(전문의 서술)와 완전히 다릅니다! ⚠️⚠️**
- ❌ 임상: "방사선 사진상 치근단 병소가 관찰됩니다." → 전문의 소견 보고체
- ✅ 정보성: "치아 뿌리 끝에 염증이 생긴 상태입니다. 마치 여드름이 뿌리 끝에 생긴 것과 유사합니다." → 전문지식+비유 설명체

**⚠️ 대화체 과다 사용 금지! 전문성이 우선!**
- ❌ "~하신 적 있으시죠? 정말 힘드시죠? 그래서 오늘은~" (대화체 과다 = 전문성 저하!)
- ✅ "이러한 증상은 치수염에서 비롯되는 경우가 많습니다. 치수 조직은~" (지식 전달 중심)
- 공감 표현은 서론에만 1~2문장, 본론은 100% 전문 지식 전달에 집중!

**어미 규칙 (절대 준수! 이 비율을 반드시 지키세요!)**:
- 기본 어미: "~입니다", "~됩니다", "~있습니다" (70%) — 10문장 중 7문장
- 전환/참여: "~하죠", "~되죠", "~이죠" (15%) — 10문장 중 1~2문장
- 전환 허용: "~인데요" (5%, 주제 전환 시에만) — 20문장 중 1문장
- 존댓말: "~시죠", "~하십니다", "~계시죠" (10%) — 10문장 중 1문장
- 🚫 절대 금지 어미: ~해요, ~거든요, ~있어요, ~드려요, ~할게요, ~볼게요
- 🚫 페르소나에서 위 어미를 사용했더라도 절대 따라하지 마세요!
- ⚠️ ~입니다만 연속 4문장 이상 사용 금지! ~하죠, ~이죠를 가끔 섞어주세요
...
- ❌ "이가 아프면 치과에 가시는 것이 좋습니다." (뻔한 내용 — 누구나 아는 이야기)
- ❌ "임플란트는 인공 치아를 심는 시술입니다." (사전적 정의만 — 검색하면 나오는 수준)
- ❌ 서론+결론만 길고 본론이 짧은 구성 (내용 부실!)
- ✅ "치수 조직까지 감염이 진행되면 자발통이 나타납니다. 쉽게 말해 신경까지 세균이 침투한 상태이죠. 이 단계에서는 근관치료가 필요하며, 보통 2~3회 내원하여 치료를 진행합니다." (구체적 + 비유)
- ✅ "임플란트 식립 시 치조골 높이가 최소 8mm 이상이어야 합니다. 마치 건물을 세우려면 기초 공사가 탄탄해야 하는 것과 같은 원리이죠." (수치 + 비유)

**🚨 내용 깊이 필수 체크 (정보성 글의 핵심!)**
정보성 글이라도 **의료 전문 지식이 담겨야** 합니다:
- 각 섹션에 최소 1개 이상의 의학적 메커니즘 설명 포함
- 구체적 수치 (기간, 확률, mm 단위 등) 최소 5개 포함
- "왜 그런지"의 원인과 "어떻게 되는지"의 과정을 반드시 설명
- 본론이 전체 글의 60% 이상 차지해야 합니다 (서론+결론 합쳐서 40% 이하!)
- ❌ 공감 표현 + 비유만으로 채우지 마세요! 비유 뒤에는 반드시 실질적 설명이 따라야 합니다

**서론 (400자) - 간결한 도입:**
✅ 인사 → 시의성 훅 → 공감 1~2문장 → 주제 소개 + 메인 키워드
- "혹시 ~하신 적 있으신가요?" (체험 공감)
- "약 ~%의 분들이 이런 증상을 겪고 계십니다." (숫자 통계)
⚠️ 공감 표현은 서론에서만! 1~2문장이면 충분합니다. 바로 본론으로 넘어가세요!

**본론 (1,200자 이상, 전체의 60%!) - 전문 지식 전달 (핵심!):**

⚠️ 본론이 글의 핵심입니다! 서론/결론은 짧게, 본론은 길고 깊게!

섹션 1: ✅ 원인/메커니즘 (500자 이상)
- **왜** 이런 문제가 발생하는지 의학적 메커니즘 설명 (피상적 서술 금지!)
- 구체적 구조/조직명 언급: "법랑질", "상아질", "치수 조직", "치주인대" 등
- 전문 용어 등장 시 비유 1개 동반 후 → 즉시 의학적 설명으로 이어가기
- 방치 시 진행 과정: 단계별 + 구체적 기간/수치 명시

섹션 2: 🔹 치료 방법/비교 (500자 이상)
- ⚠️ **번호 매긴 단계 목록 금지!** ("1단계: ~, 2단계: ~" 형태 절대 금지!)
- ✅ 치료 과정을 자연스러운 서술체로 풀어서 설명
- ✅ "먼저 ~를 진행하게 됩니다. 이후 ~를 확인한 뒤, ~로 이어집니다." 형태
- 각 과정에서 사용하는 재료, 장비, 기간을 구체적으로 명시
- 치료 옵션이 여러 개일 때: 각 옵션의 차이점을 설명

섹션 3: 🔵 Q&A + 관리 팁 (300자 이상)
- 자주 묻는 질문 2개 (Q&A 형태)
- 구체적이고 실천 가능한 관리 팁 (수치 포함)

**결론 (300자) - 간결한 마무리:**
- 핵심 요약 2문장 (길게 늘이지 말 것!)
- 정기검진 권유 1문장
- 마무리 인사

**정보성 모드 예시 문장 (이런 톤으로 작성!):**
- "치아는 법랑질, 상아질, 치수 조직의 3중 구조로 이루어져 있습니다. 마치 여러 겹의 옷을 입고 있는 것과 유사하죠."
- "치수 조직까지 세균 감염이 도달하면, 자발적인 통증이 발생합니다. 이 단계에서는 근관치료가 필수적으로 고려됩니다."
- "임플란트 픽스쳐는 직경 3.5~5.0mm, 길이 8~13mm 범위에서 잔존 골량에 따라 선택됩니다."
- "잇몸뼈가 부족한 경우, 골이식을 먼저 시행하게 됩니다. 마치 건물 기초 공사를 먼저 하는 것과 같은 원리이죠."
- "치료 후 골유착까지는 보통 3~6개월이 소요되며, 이 기간 동안 뼈와 임플란트가 단단하게 결합됩니다."
...
// 배치 다양성 지시 프롬프트 생성
function buildDiversityDirective(hints: BatchDiversityHints, hasPersona?: boolean): string {
...
`
  ...
  if (hasPersona) {
    // 페르소나가 있을 때: 치과 고유 스타일 DNA를 우선, 아래 패턴은 보조
    directive += `
⚠️ **이 치과의 "스타일 DNA"와 "서문 샘플"이 가장 우선입니다!**
아래 다양성 패턴은 서문 샘플의 흐름과 자연스럽게 조합하여 사용하세요.
서문 샘플의 도입 방식/문장 순서/공감 표현 흐름을 먼저 따르되,
아래 패턴으로 변주를 주세요:

### 인사말 변형:
"${greeting}" → 기존 글의 인사 스타일을 기반으로 변형

### 공감 훅 변형 (기존 글 도입 방식과 조합):
"${empathyHook}"
...
- ⚠️ 기존 글 참조 데이터가 없으므로, CC/메모와 치료 주제를 중심으로 글을 구성하세요
- CC가 상세할수록 더 구체적인 임상 글을 작성. CC가 없으면 주제 기반 일반 임상 케이스로 구성
...
**글 작성 방식:**
- 특정 사례가 아닌 **일반적인 정보 제공** 형태로 작성
- "~하신 분들이 많습니다", "~한 경우가 있습니다" 형태로 작성
- 개인을 특정할 수 있는 정보 일체 금지
- ⚠️ "환자"라는 단어 자체를 본문에서 절대 사용 금지!
  - ❌ "환자의 상태" → ✅ "개인별 상태", "각자의 상태"
  - ❌ "환자에 따라" → ✅ "개인에 따라", "사람마다"
  - ❌ "환자분" → ✅ "분", "내원하시는 분"
...
## 🚫 효과 보장/과장 표현 금지 (추가 패턴)

**아래 패턴은 의료광고법 위반 소지가 있으므로 절대 사용 금지:**
- ❌ "가장 유사한/효과적인/좋은" → ✅ "유사한/효과적인/좋은" (최상급 표현 제거)
- ❌ "~를 제공합니다" (효과 보장) → ✅ "~가 기대됩니다", "~로 알려져 있습니다"
- ❌ "~가 가능합니다" (확정적) → ✅ "~가 고려될 수 있습니다"
- ❌ "회복할 수 있는" (확정) → ✅ "회복이 기대되는"
- ❌ "충분히 견딜 수 있는" → ✅ "높은 내구성을 보이는 것으로 알려져 있습니다"

## 🚫 "환자" 단어 본문 사용 금지

**"환자"라는 단어 자체를 본문에서 사용하지 마세요:**
- ❌ "환자의 상태", "환자에게", "환자분" → ✅ "개인별 상태", "치료 대상", "분"
- ❌ "환자마다" → ✅ "개인에 따라", "사람마다"
- 유일한 예외: "환자 정보" 같은 메타 설명 맥락만 허용
...
🚨🚨🚨 절대 규칙: 순수 본문 최소 2,500자 이상!! 🚨🚨🚨

**글자수 계산에서 제외되는 항목:**
- 📷 이미지 플레이스홀더 전체 (📷 [이미지 위치: ...] + alt 텍스트)
- ※ 부작용 고지문
- # 해시태그
- 마크다운 기호 (#, **, ---)

❌ 1,700자(공백 제외 순수 글자수) 미만 = 글자수 부족!! 본문을 더 상세하게 작성하세요!!
✅ 목표: 약 2,000자 (공백·이미지·고지문·해시태그 제외 순수 글자수!)

⚠️ 네이버 알고리즘은 충분한 분량의 상세한 글을 선호합니다!
⚠️ 이미지 플레이스홀더가 많을수록 순수 본문을 더 길게 작성해야 합니다!
...
4. **키워드 밀도**: 서브 키워드 각 2~3회 (과잉 반복 금지)
5. **동의어/관련어 활용**: 같은 단어가 글 전체에서 7~8회 이상 반복되면 반드시 동의어로 교체!
6. **"치과" 형태소**: 글 전체에서 최대 7~8회 (인사 포함), 본문에서는 최소화
...
⚠️⚠️⚠️ 글자수 핵심 규칙 ⚠️⚠️⚠️
📷 이미지 플레이스홀더는 글자수에 포함되지 않습니다!
이미지 6개 = 약 600자가 제외되므로, 총 작성 분량 3,100자 이상이어야 순수 본문 2,500자를 달성합니다!
서론 600자 + 본론 1,800자 + 결론 600자 = 3,000자 이상 (이미지 제외 순수 본문)

### 📌 서론 (600자 내외 — 이미지 제외 순수 텍스트 기준!)

**제목**: 25~35자 이내 (절대 초과 금지!), 치료 키워드를 제목 **맨 앞**에 배치
- ❌ 치과명을 제목에 포함 금지! (의료광고법 리스크)
- ❌ 40자 이상 = 실패 (네이버 검색결과에서 잘림)
- ✅ 예: "치근단 병소, 임플란트로 회복하는 과정" (28자)
- ✅ 예: "어금니 임플란트 골이식부터 보철까지" (18자)
...
5. 주제 요약 (1문장): 오늘 다룰 핵심 내용을 자연스러운 문장으로 요약 (메인키워드 포함)
   - ❌ "💡 핵심:" 같은 이모지 강조 블록 금지 (AI 티 유발!)
   - ✅ "오늘은 ~에 대해 상세히 설명드리겠습니다." 형태
...
## 📊 최종 자가 검증 (작성 완료 전 필수 확인!)
**순수 본문 기준 (📷이미지·※고지문·#해시태그 제외):**
- 서론: 500자 내외인가? ☐
- 본론: 1,500자 이상인가? ☐ (부족하면 치료 단계별 3~4문장 추가!)
- 결론: 500자 내외인가? ☐
- 총합: 2,500자 이상인가? ☐ (핵심! 이것만은 반드시!)
- 메인키워드 7회 분산 배치인가? ☐ (제목1 + 서론1 + 본론4 + 결론1)
- 제목: 35자 이내인가? ☐ (치과명 포함 안 했는가? ☐)
- "환자" 단어를 본문에서 사용하지 않았는가? ☐
- "불편"을 독립 단어로 사용하지 않았는가? ☐
- "가장 유사한/효과적인" 등 최상급 표현 없는가? ☐
- 💡 이모지 강조 블록 없는가? ☐

만약 글자수가 부족하다면:
1. 서론: 시의성 훅과 CC 관련 배경 설명 2~3문장 추가
2. 본론: 각 치료 단계마다 부연 설명 + 주의점 추가, Q&A 2개 추가
3. 결론: 핵심 요약 3~4문장 + 구체적 관리법 5가지 + 정기검진 주기 명시
...
---METADATA_START---
{
  ...
  "charCount": 순수본문글자수(📷이미지·※고지문·#해시태그·공백 모두 제외)
}
---METADATA_END---
...
⚠️ charCount 계산 시 반드시 아래를 제외하세요:
- 📷 [이미지 위치: ...] (alt: ...) 전체 텍스트
- ※ 부작용 고지문 전체
- #해시태그 전체
- 마크다운 기호 (#, **, ---)
- 공백·줄바꿈 (띄어쓰기, 개행 모두 제외)
charCount가 1,700 미만이면 본문을 더 길게 작성하세요! (공백 제외 순수 글자수, 목표 약 2,000자)
`
}

// 글자수 계산 함수 (post-validator.ts와 동일 로직 — 이미지/고지문/해시태그/공백 제외)
function countContentChars(content: string): number {
  ...
  text = text.replace(/\*(.*?)\*/g, '$1')
  text = text.replace(/---+/g, '')
  text = text.replace(/^\s*[-*✅🔹💚⚠️]\s*/gm, '')
  // 공백·줄바꿈 제거 후 순수 글자수만 카운트
  text = text.replace(/\s+/g, '')
  return text.length
}

// ── P1: ~요 어미 자동치환 함수 (LLM 출력 후처리) ──
// 임상 모드: 모든 ~요 어미를 ~다 체로 변환
// 정보성 모드: 금지 어미만 변환 (~인데요는 허용)
function sanitizeForbiddenEndings(text: string, writingMode?: WritingMode): string {
  let result = text

  // 공통 금지 어미 (양쪽 모드 모두 치환)
  result = result.replace(/해요/g, '합니다')
  result = result.replace(/거든요/g, '기 때문입니다')
  result = result.replace(/있어요/g, '있습니다')
  result = result.replace(/드려요/g, '드립니다')
  result = result.replace(/할게요/g, '하겠습니다')
  result = result.replace(/볼게요/g, '보겠습니다')
  result = result.replace(/줄게요/g, '주겠습니다')
  result = result.replace(/같아요/g, '같습니다')
  result = result.replace(/싶어요/g, '싶습니다')
  result = result.replace(/갈게요/g, '가겠습니다')
  result = result.replace(/나요\?/g, '나요?') // Q&A에서는 허용
  result = result.replace(/(?<!나|까|인가)요\./g, '습니다.') // 문장 끝 ~요. → ~습니다.

  // 임상 모드: 추가로 ~인데요, ~네요, ~세요도 치환
  if (writingMode === 'expert') {
    result = result.replace(/인데요/g, '인데,')
    result = result.replace(/네요/g, '습니다')
    result = result.replace(/하세요/g, '하시길 바랍니다')
    result = result.replace(/되세요/g, '되시길 바랍니다')
    result = result.replace(/으세요/g, '으시길 바랍니다')
  }
  // 정보성 모드: ~인데요는 허용 (10%), ~네요/~세요도 제한적 허용
...
## 환자 정보 일반화 규칙
${topicMatchQuality === 'low' || topicMatchQuality === 'none'
  ? `🚨 **RAG 참조글이 부족합니다!** CC/메모가 글의 핵심 뼈대입니다!
- CC의 치식번호, 부위, 증상, 치료 단계를 **빠짐없이** 임상 소견으로 전개하세요
- CC 내용이 본론의 **60% 이상**을 구성해야 합니다
- CC가 비어있다면 "${data.topic}" 주제에 대한 일반적인 임상 케이스를 상세하게 구성하세요
- 표현만 일반화: "이런 증상이 있으신 분들", "이런 경우" 형태로 서술`
...
### 🎯 메인키워드: "${mainKeyword}"
⚠️⚠️ **메인키워드 "${mainKeyword}"를 제목 포함 총 7회 필수 배치!** ⚠️⚠️
- 제목: 1회 (제목 앞쪽에 배치)
- 서론: 1회 (인사말 또는 초반 200자 이내)
- 본론: 4회 (300~400자 간격으로 자연스럽게 분산)
- 결론: 1회 (마무리 인사 또는 마지막 200자 이내)
- ❌ 한 문단에 메인키워드 2회 이상 몰리면 안 됩니다!
- ✅ "${mainKeyword}" 형태 그대로 사용 (띄어쓰기 포함, 변형 금지)
...
### ⚠️⚠️⚠️ 글자수 (순수 본문 기준! 📷이미지·#해시태그·※고지문 전부 제외!) ⚠️⚠️⚠️
- **서론**: 600자 (이미지 플레이스홀더 제외 순수 텍스트!)
- **본론**: 1,800자 (이미지 플레이스홀더 제외 순수 텍스트!)
- **결론**: 600자 (이미지 플레이스홀더 제외 순수 텍스트!)
- **⭐ 총합: 순수 본문 3,000자 이상!! (이미지·해시태그·고지문 제외) ⭐**

⚠️ 이미지 플레이스홀더 6개 ≈ 600자가 제외됩니다!
⚠️ 당신이 3,000자를 작성했다고 생각해도, 이미지 제외 시 2,400자밖에 안 됩니다!
⚠️ 따라서 마크다운 포함 총 3,600자 이상을 작성해야 순수 본문 3,000자가 됩니다!

🚨🚨🚨 절대 규칙: 순수 본문 2,500자 미만 = 완전 실패!! 🚨🚨🚨
✅ 각 섹션의 글자수를 반드시 채우세요!
✅ 서론이 짧으면 시의성 훅과 CC 공감 배경을 더 상세히!
✅ 본론이 짧으면 각 치료 단계마다 3~4문장씩 상세 설명, Q&A 추가!
✅ 결론이 짧으면 핵심 요약 3~4문장 + 관리법 5가지 + 정기검진 당부!

### 메인키워드 배치 확인 (7회 필수!)
위 키워드 전략에 따라 "${mainKeyword}" 총 7회 분산 배치 (한 문단 2회 이상 금지).
"${mainKeyword}" 형태 그대로 사용 (띄어쓰기 변형 금지).
⚠️ 본론에서 4회 분산: 소견 섹션 1회 + 치료 과정 2회 + 주의사항/예후 1회.
⚠️ 작성 완료 전 "${mainKeyword}" 출현 횟수를 반드시 세어보세요!

### 금칙어 회피 규칙 (필수 준수!)
⚠️ 아래 단어가 발견되면 반드시 교체하세요:
- "불편" → "통증" 또는 "이상" (독립 단어로 사용 금지, "불편감"은 허용)
- "환자" → 본문에서 절대 사용 금지! ("개인에 따라", "사람마다", "분", "각자" 등으로 대체)
- "해결" → "개선", "회복", "처치" (⚠️ "해결"은 의료법상 효과 보장 뉘앙스!)
- "가장" → 삭제 (최상급 표현 금지)
- "~를 제공합니다" → "~가 기대됩니다", "~로 알려져 있습니다"
- "충분히 그러실 수 있습니다" 같은 맥락 없는 위로 문장 금지
...
**글 전체 반복 횟수 상한선:**
- "치과": 최대 7~8회 (서문 인사1 + 본론 4~5 + 결론 인사1~2)
- 치료명(임플란트/신경치료 등): 최대 5~6회
- 기타 일반 명사: 최대 4~5회
...
export async function POST(request: NextRequest) {
  try {
    ...
    // 배치 다양성 지시 생성 (페르소나 존재 시 스타일 DNA 우선)
    const diversityDirective = data.diversityHints
      ? buildDiversityDirective(data.diversityHints, !!clinicPersona)
      : ''
    ...
    const userPrompt = buildUserPrompt(
      ...
      clinicPersona?.topicMatchQuality // RAG 주제 매칭 품질
    )
    ...
    const stream = new ReadableStream({
      async start(controller) {
        try {
          ...
          // ── P1: ~요 어미 자동치환 (LLM이 생성해도 후처리에서 강제 변환) ──
          const sanitizedContent = sanitizeForbiddenEndings(rawContent, data.writingMode)
          if (sanitizedContent !== rawContent) {
            const diffCount = (rawContent.match(/해요|거든요|있어요|드려요|할게요|볼게요|줄게요|같아요|싶어요|네요|갈게요/g) || []).length
            console.log(`[PostProcess] ~요 어미 ${diffCount}건 자동 치환됨`)
          }

          // 44byte 줄바꿈 후처리 (네이버 블로그 최적화)
          const content = formatLineBreaks(sanitizedContent)
          ...
          // ~요 어미 잔존 검증 (치환 후에도 남은 것이 있는지 확인)
          ...
          if (foundEndings.length > 0) {
            console.warn(`[Warning] 치환 후에도 금지 어미 잔존: ${foundEndings.join(', ')}`)
            warnings.push(`🚫 금지 어미(~요) 잔존: ${foundEndings.join(', ')} — 수동 수정 필요`)
          }

          // 글자수 경고 (공백 제외 순수 글자수 기준: 2,000자 ±300)
          if (metadata.charCount < 1700) {
            warnings.push(`⚠️ 글자수 부족: ${metadata.charCount}자 (권장: 1,700자 이상, 공백·이미지·고지문·해시태그 제외)`)
          }
