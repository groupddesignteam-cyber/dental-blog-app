...
${writingMode === 'expert' ? `
## 글 구조 - 임상 케이스 중심 (총 2,500자 이상 / 공백 제외)

⚠️⚠️ 이 글은 정보성(백과사전식) 글이 아닙니다! ⚠️⚠️
✅ 전문의가 임상 케이스를 설명하는 글입니다.
❌ "~란 무엇일까요?", "~에 대해 알아보겠습니다" 같은 정보성 도입 금지!

### 📌 제목 (25~35자)
- 케이스 중심 제목: "[증상/상태], [치료] 과정" 형태
- 예: "다수 결손치와 치주염, 임플란트 식립부터 보철 완성까지"
- 예: "치근단 병소, 신경치료 후 지르코니아 보철로 회복하는 과정"
- ❌ "임플란트란?", "신경치료의 모든 것" 같은 정보성 제목 금지!

### 📌 서론 (500자 내외)
1. 인사 (1~2문장): "안녕하세요, [지역] [치과명] [원장님이름]입니다."
2. 시의성 훅 (1~2문장)
3. CC 기반 케이스 소개 (3~5문장):
   - "오늘은 [상태]에서 [치료]를 통해 [기능]을 회복하는 과정을 설명드리겠습니다."
   - CC 정보를 임상 케이스의 도입부로 활용

### 📌 ✅ 초진 소견 및 치료 계획 (500자 이상)
**이 섹션이 핵심입니다!**
- 📷 이미지: 초진 파노라마 X-ray 또는 구강 내 사진
- "방사선 사진상 [부위]에 [소견]이 관찰됩니다."
- "이는 [진단]을 시사하는 소견입니다."
- 잔존 치아 상태, 치조골 흡수 정도, 결손 부위 등 기술
- "이러한 경우 [치료계획]을 수립하였습니다." (구체적 계획)
- Q&A 블록: "Q. [핵심 질문]? A. [답변 2~3문장]"

### 📌 🔹 단계별 치료 과정 (1,000자 이상, 핵심 섹션!)

**반드시 "N단계" 형식으로 치료 과정을 순서대로 기술하세요!**
CC/메모에 기재된 치료 내용을 단계별로 분할하여 상세 설명합니다.

각 단계마다:
- 소제목: "🔹 N단계: [치료 내용]"
- 📷 이미지: 해당 단계의 임상 사진/X-ray
- "사진을 보시면, [부위]에 [소견]이 확인됩니다."
- 시행한 처치의 구체적 방법, 재료, 수치 기술
- 전문 용어 + 괄호 해설: "차폐막(멤브레인)", "픽스쳐(인공 치근)"

**단계 예시 (치료에 맞게 변형):**
- 1단계: 발치/염증 조절/상악동 거상술
- 2단계: 골이식/픽스쳐 식립
- 3단계: 2차 수술/보강관 교체
- 4단계: 최종 지르코니아 보철 장착

### 📌 🔵 경과 관찰 및 마무리 (500자 이상)
- 📷 이미지: 최종 보철 완료 사진, 술후 X-ray
- 방사선 사진상 골유착/치유 상태 확인 소견
- 보철물 적합도 평가
- 정기검진 주기 권고 (3~6개월 간격)
- 관리 방법 (전문가 권고)
- 마무리 인사: "[치과명] [원장님이름]이었습니다. 감사합니다."
...
## 📊 임상 글 자가 검증
- 정보성(백과사전) 글이 아닌 케이스 기반 글인가? ☐
- 제목이 케이스 중심인가? (❌ "~란?", ✅ "[상태], [치료] 과정") ☐
- 초진 소견이 구체적인가? ("방사선 사진상~가 관찰됩니다") ☐
- 단계별 치료 과정이 "N단계" 형식으로 기술되었는가? ☐
- 각 단계에 이미지 배치 + 임상 소견 기술이 있는가? ☐
- 전문 용어마다 괄호 해설이 있는가? ☐
- 총 글자수 2,500자 이상인가? ☐
- 메인키워드 7회 분산 배치인가? ☐
` : `
...
## 전문용어 설명 + ${writingMode === 'expert' ? '괄호 해설 패턴' : '비유 패턴'} (중요!)
${writingMode === 'expert' ? `
전문용어를 사용할 때는 괄호 안에 쉬운 설명을 병기하세요:
- "치조골(잇몸뼈) 흡수가 진행된 양상이 관찰됩니다."
- "상악동 거상술(위턱 내부 공간을 들어올려 뼈를 보충하는 시술)을 시행하였습니다."
- "차폐막(멤브레인)을 피개하여 골재생을 유도합니다."
- "픽스쳐(인공 치근)가 안착될 수 있는 충분한 골량을 확보합니다."
` : `
