...
export const EMPATHY_PHRASES = [
  '이런 증상으로 불편을 겪는 분들이 계십니다.',
  '갑작스러운 변화에 걱정이 앞서실 수 있습니다.',
  '일상생활에서 작지 않은 불편함을 느끼셨을 텐데요.',
  '이런 상황이면 어떻게 해야 할지 막막하실 수 있습니다.',
  '치료를 결심하기까지 많은 고민이 있으셨으리라 생각합니다.',
]
