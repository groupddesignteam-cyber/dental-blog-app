...
### 반복 횟수 제한 (절대 규칙!)
- **"치과"**: 글 전체에서 최대 7회 (서론 인사 1 + 본론 4~5 + 결론 인사 1)
- **치료 키워드** (임플란트, 신경치료 등): 메인키워드에 포함된 경우 단독 사용 최대 3회, 미포함 시 최대 5회
- **기타 일반 단어** (치료, 진행, 확인, 상태 등): 한 섹션(##) 내 동일 단어 3회 미만! 글 전체 7회 미만!
